...
public class Factory implements IFactory, Serializable {
	...
	public IInterface createInterface(final char[] anID, final char[] aName,String localPath) {
		return new Interface(anID, aName,localPath);
	}
	public IMemberClass createMemberClass(final char[] anID, final char[] aName,String localPath) {
		return new MemberClass(anID, aName,localPath);
	}
	...
	public IMemberInterface createMemberInterface(
		final char[] anID,
		final char[] aName,String localPath) {

		return new MemberInterface(anID, aName,localPath);
	}
