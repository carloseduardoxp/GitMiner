...
import miner.control.ImportMetricsControl;
 ...
 */
public class ImportMetricsView extends javax.swing.JInternalFrame implements Observer, ActionListener {

    private final ImportMetricsControl control;
    ...
    Timer timer;    
    /**
     * Creates new form ImportMetricsView
     */
    public ImportMetricsView() {
        control = new ImportMetricsControl();
        initComponents();
        lblMsg.setText("");
    }

    public ImportMetricsControl getControl() {
        return control;
    }
        ...
        if (!this.timer.isRunning()) {
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    ImportMetricsView view = ImportMetricsView.this;
                    timer.start();
                    try {
                        long tempoInicial = System.currentTimeMillis();
                        control.importMetrics(view);
