...
import miner.control.InterRelationSmellsControl;
 ...
 */
public class InterRelationSmellsView extends javax.swing.JInternalFrame implements Observer, ActionListener {

    private final InterRelationSmellsControl control;
     ...
     */
    public InterRelationSmellsView() {
        control = new InterRelationSmellsControl();
        initComponents();
        lblMsg.setText("");
    }

    public InterRelationSmellsControl getControl() {
        return control;
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Inter Relation Smells");
        ...
        if (!this.timer.isRunning()) {
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    InterRelationSmellsView view = InterRelationSmellsView.this;
                    timer.start();
                    try {
                        long tempoInicial = System.currentTimeMillis();
                        control.execute(view);
